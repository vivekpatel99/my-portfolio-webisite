  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content={`Case study for the ${project.title} project. Discover the challenges, solutions, and results achieved by Vivek Patel, AI & Computer Vision Engineer.`}
        />
        <meta
          name="keywords"
          content={`${project.title}, case study, portfolio, Vivek Patel, ${project.category}, AI project, web development`}
        />
        ...
        <meta
          ...
          content={`Case study for the ${project.title} project. Discover the challenges, solutions, and results achieved.`}
        />
        ...
        <meta
          name="twitter:title"
          content={`${project.title} | Project Case Study - Vivek Patel`}
        />
        <meta
          ...
          <div className="container mx-auto px-6 mb-16">
            <div className="aspect-video rounded-2xl overflow-hidden">
              <img
                ...
                src={project.images.gallery2[0].src}
              />
            </div>
          </div>
        </SectionAnimator>
            ...
            <div className="container mx-auto px-6">
              <div className="flex justify-center items-center gap-4">
                <Button
                  asChild
                  variant="outline"
                  className="border-accent-purple/40 hover:bg-accent-purple/10 text-white rounded-full text-lg py-7 px-10"
                >
                  <Link to="/">
