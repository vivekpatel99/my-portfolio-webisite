  ...
  return (
    isManaging ? (
        <motion.div
          ...
          className="fixed inset-x-0 bottom-0 z-40 max-h-[calc(100dvh-5rem)] overflow-y-auto rounded-t-2xl p-3 sm:inset-x-auto sm:top-auto sm:bottom-4 sm:left-auto sm:right-4 sm:w-auto sm:max-w-lg sm:max-h-[calc(100dvh-2rem)] sm:rounded-2xl sm:p-6 bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl shadow-black/30"
        >
