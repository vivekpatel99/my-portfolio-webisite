          ...
          <div className="grid lg:grid-cols-[minmax(0,1.7fr)_minmax(260px,0.72fr)] gap-2 items-center max-lg:grid-cols-1 max-lg:gap-3 max-md:gap-0">
            ...
            <div className="flex flex-col gap-2 min-w-0 w-full max-lg:gap-0">
              ...
              >
                ...
                {/* Header */}
                <div className="flex justify-between items-start mb-5 pb-3.5 border-b border-white/[0.08] max-md:mb-1 max-md:pb-1">
                  <div>
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-3 mb-3 max-md:grid-cols-1 max-md:gap-y-1 max-md:mb-1" role="group" aria-label="Detected credentials">
