...
### Added
- Service offers now show from €45/hour, typical duration, and in-scope vs out-of-scope lists
...
- Homepage, meta, and JSON-LD now show Starting at €45/hour (euro; Europe). Retired €80.
